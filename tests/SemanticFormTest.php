...
use BlackIT\SemanticForm\SemanticForm;
...
class SemanticFormTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $oldInput = Mockery::mock('BlackIT\SemanticForm\OldInput\OldInputInterface');
    ...
    {
        $errorStore = Mockery::mock('BlackIT\SemanticForm\ErrorStore\ErrorStoreInterface');
    ...
    public function testFieldCallback()
    {
        ...
        $callback = function (\BlackIT\SemanticForm\Elements\Field $field) {
